''' Extract point time series from WRF-Hydro NRT simulation for given sites

Usage:
    python extract_points_nrt.py [domain] [yyyymm1] [yyyymm2]
Default values:
    must specify all
'''
...
def main(argv):
    ...
    if not os.path.isdir('basins/sites'):
        os.system('mkdir -p basins/sites')
