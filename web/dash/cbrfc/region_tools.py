...
def get_region_tools():
    ...
    fnf_sites = dl.GeoJSON(url='assets/fnf_stations_info_all.pbf', format='geobuf', id='fnf-sites',
    ...
    cbrfc_bound = dl.GeoJSON(url='assets/cbrfc_ygs_20.pbf', format='geobuf', id='cbrfc-bound',
